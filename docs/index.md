...
The catalog consists of the following principal tables:

- **Source Table** – One row per unique source containing coordinates and source-level information.
- **Measurement Table** – Radio and supplementary multiwavelength measurements.
...
Detailed documentation for each table is available from the navigation menu.
...
If you use this catalog in your research, please cite the accompanying publication describing the catalog.
